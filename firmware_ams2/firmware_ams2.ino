...
Original firmware for the 2 stepper drawing machine.
Uses the motor shield version 2.

note: this is is the one that can take as input the G-CODE in the serial monitor
      very usefull for testing purpose
      pay attention to the G-CODE syntax (semicolon, X and Y command..)
      .. do not rememebr them exaclty.. there was some trick like 
      "X01.00" and not simply "X1"..
      will be a nice TODO write them down.. 
